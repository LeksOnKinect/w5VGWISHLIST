...
<input type="hidden" name = "id" value="${listToEdit.id}"><br />
List Name: <input type = "text" name = "listName" value = "${listToEdit.listName}"><br />
Wish Date: <input type = "text" name = "month" placeholder = "mm" size = "4" value = "${month}">
<input type = "text" name = "day" placeholder="dd" size = "4" value = "${date}">,
<input type = "text" name = "year" placeholder = "yyyy" size = "4" value = "${year}">
Shopper Name: <input type = "text" name = "shopperName" value = "${listToEdit.wisher.wisherName}"><br />
